import{g as R,b as N,c as g,a as l,f as h,n as $}from"./scroll-up-51cac475.js";const x=document.querySelector(".fav-container-js");x.addEventListener("click",q);function q(e){if(!e.target.classList.contains("btn-see-recipe-js"))return;const n=e.target.closest(".btn-see-recipe-js").dataset.id;V(n)}async function V(e){try{const t=await R(e);_(t)}catch(t){console.log(t)}}function _(e){const t=N.create(O(e));t.show();const n=document.querySelector(".js-modal-video"),a=document.querySelector(".js-modal-img");W(e.youtube,n,a);const i=document.querySelector(".js-favorite-btn");(JSON.parse(localStorage.getItem(g.LS_RECIPES))??[]).find(({_id:c})=>c===e._id)?i.textContent="Remove":i.textContent="Add to favorite",i.addEventListener("click",()=>{i.textContent=Y(e);const c=JSON.parse(localStorage.getItem(g.LS_RECIPES));x.innerHTML=l(c),h(),S(),t.close(),location.reload(!0)}),document.querySelector(".js-modal-close").addEventListener("click",()=>t.close()),document.addEventListener("keydown",c=>{c.code==="Escape"&&(t.close(),document.removeEventListener("keydown"))})}function O(e){let t;const{thumb:n,title:a,rating:i,time:o,instructions:u,ingredients:d,tags:c,youtube:w}=e,j=i.toFixed(1),T=d.map(({name:k,measure:P})=>`<li class="ing-item">
    ...
    </li>`,a=Math.round(e);let i=[];for(let o=0;o<5;o++)o+1>a?i.push(n):i.push(t);return i.join("")}function U(e){let t=e,n=t.indexOf("=");if(n!==-1)return t.substring(n+1)}function W(e,t,n){e||(t.classList.add("is-none"),n.classList.remove("is-none"))}function Y(e){const t=JSON.parse(localStorage.getItem(g.LS_RECIPES))??[],n=t.find(({_id:i})=>i===e._id),a=t.findIndex(({_id:i})=>i===e._id);if(n){t.splice(a,1),localStorage.setItem(g.LS_RECIPES,JSON.stringify(t));let i="Add to favorite";return $.Notify.warning("The recipe removed from favorites"),i}else{t.push(e),localStorage.setItem(g.LS_RECIPES,JSON.stringify(t));let i="Remove";return $.Notify.success("The recipe is added to favorites"),i}}let L,s=JSON.parse(localStorage.getItem(g.LS_RECIPES))??[],b,C=1;const A=document.querySelector(".fav-empty"),r=document.querySelector(".fav-container"),M=document.querySelector(".fav-categories"),p=document.querySelector(".fav-static");G();function G(){if(s.length)A.classList.add("is-none"),F(),I(),et();else return}function I(){const e="category",t=s.map(i=>i[e]),a=[...new Set(t)];a.unshift("All categories"),K(a)}function K(e){M.innerHTML=D(e),document.querySelectorAll(".js-category-btn").forEach(n=>{n.addEventListener("click",function(a){const i=a.currentTarget.getAttribute("data-button");i==="All categories"?F():z(i)})})}function z(e){const t=s.filter(n=>n.category===e);document.getElementById("paginationFAV").innerHTML="",r.innerHTML=l(t),h(),S()}function D(e){return e.map(t=>`<button class="category-btn js-category-btn" data-button="${t}">${t}</button>`).join("")}function F(){s.length>12&&window.innerWidth>767?(b=s.slice(0,12),r.innerHTML=l(b),f(s)):s.length>9&&window.innerWidth<=767?(b=s.slice(0,9),r.innerHTML=l(b),f(s)):(document.getElementById("paginationFAV").innerHTML="",r.innerHTML=l(s)),h(),S(),p.classList.contains("fav-phantom")&&(p.classList.remove("fav-phantom"),r.classList.remove("fav-style-reset"))}function f(e,t=C){const n=Math.ceil(e.length/12),a=t,i=Z(n,a),o=Number(i)+2;if(n===1)return document.getElementById("paginationFAV").innerHTML="";const u=Q(a),d=tt(i,o,n,t),c=X(a,n),w=`<div class="pagination-bar">
    <div class="pag-btn-block">${u}</div>
    <div class="pag-btn-block">${d}</div>
    <div class="pag-btn-block">${c}</div>
  </div>`;document.getElementById("paginationFAV").innerHTML=w,h(),S()}function Q(e){const t=e-1;let n="pag-btn-number";return Number(e)===1&&(n=""),`<button
      id="pag-btn-start"
    ...
    >
      <span class="icon-wrap left-single"></span>
        ...
        >
          ...
        </button>`),i}let v=0,y=12,m;document.addEventListener("click",async e=>{const t=e.target.closest(".pag-btn-number");if(b=E(t),t){L=t;const n=t.getAttribute("page-number"),a=l(b);r.innerHTML=a,f(s,n)}});function E(e){return e===1?s.slice(0,12):(e&&(m=e.getAttribute("page-number")),s.length>12&&window.innerWidth>767?(v=12*m-12,y=12*m,s.slice(v,y)):(v=9*m-9,y=9*m,s.slice(v,y)))}function et(){r.addEventListener("click",e=>{if(!e.target.classList.contains("js-add"))return;const t=e.target.dataset.id,n=s.findIndex(({_id:a})=>a===t);s.splice(n,1),localStorage.setItem(g.LS_RECIPES,JSON.stringify(s)),nt(L??1),I(),s.length||(A.classList.remove("is-none"),p.classList.add("fav-phantom"),r.classList.add("fav-style-reset"),M.innerHTML="")})}function S(){document.querySelectorAll(".js-add").forEach(t=>t.classList.add("liked"))}function nt(e){s.length>12&&window.innerWidth>767?(L&&(C=L.getAttribute("page-number")),r.innerHTML=l(E(e)),f(s)):s.length>9&&window.innerWidth<=767?(r.innerHTML=l(E(e)),f(s)):(document.getElementById("paginationFAV").innerHTML="",r.innerHTML=l(s)),p.classList.contains("fav-phantom")&&(p.classList.remove("fav-phantom"),r.classList.remove("fav-style-reset"))}
