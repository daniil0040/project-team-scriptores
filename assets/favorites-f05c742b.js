import{g as R,b as N,c as g,a as l,f as b,n as x}from"./scroll-up-5fcc5428.js";const C=document.querySelector(".fav-container-js");C.addEventListener("click",q);function q(e){if(!e.target.classList.contains("btn-see-recipe-js"))return;const n=e.target.closest(".btn-see-recipe-js").dataset.id;V(n)}async function V(e){try{const t=await R(e);_(t)}catch(t){console.log(t)}}function _(e){const t=N.create(O(e));t.show();const n=document.querySelector(".js-modal-video"),a=document.querySelector(".js-modal-img");W(e.youtube,n,a);const i=document.querySelector(".js-favorite-btn");(JSON.parse(localStorage.getItem(g.LS_RECIPES))??[]).find(({_id:c})=>c===e._id)?i.textContent="Remove":i.textContent="Add to favorite",i.addEventListener("click",()=>{i.textContent=Y(e);const c=JSON.parse(localStorage.getItem(g.LS_RECIPES));C.innerHTML=l(c),b(),m(),t.close(),location.reload(!0)}),document.querySelector(".js-modal-close").addEventListener("click",()=>t.close()),document.addEventListener("keydown",c=>{c.code==="Escape"&&(t.close(),document.removeEventListener("keydown"))})}function O(e){let t;const{thumb:n,title:a,rating:i,time:o,instructions:u,ingredients:d,tags:c,youtube:w}=e,j=i.toFixed(1),T=d.map(({name:k,measure:P})=>`<li class="ing-item">
    ...
    </li>`,a=Math.round(e);let i=[];for(let o=0;o<5;o++)o+1>a?i.push(n):i.push(t);return i.join("")}function U(e){let t=e,n=t.indexOf("=");if(n!==-1)return t.substring(n+1)}function W(e,t,n){e||(t.classList.add("is-none"),n.classList.remove("is-none"))}function Y(e){const t=JSON.parse(localStorage.getItem(g.LS_RECIPES))??[],n=t.find(({_id:i})=>i===e._id),a=t.findIndex(({_id:i})=>i===e._id);if(n){t.splice(a,1),localStorage.setItem(g.LS_RECIPES,JSON.stringify(t));let i="Add to favorite";return x.Notify.warning("The recipe removed from favorites"),i}else{t.push(e),localStorage.setItem(g.LS_RECIPES,JSON.stringify(t));let i="Remove";return x.Notify.success("The recipe is added to favorites"),i}}let p,s=JSON.parse(localStorage.getItem(g.LS_RECIPES))??[],f,E=1;const A=document.querySelector(".fav-empty"),r=document.querySelector(".fav-container"),M=document.querySelector(".fav-categories"),y=document.querySelector(".fav-static");G();function G(){if(s.length)A.classList.add("is-none"),F(),I(),et();else return}function I(){const e="category",t=s.map(i=>i[e]),a=[...new Set(t)];a.unshift("All categories"),K(a)}function K(e){M.innerHTML=D(e),document.querySelectorAll(".js-category-btn").forEach(n=>{n.addEventListener("click",function(a){const i=a.currentTarget.getAttribute("data-button");i==="All categories"?F():z(i)})})}function z(e){const t=s.filter(n=>n.category===e);document.getElementById("paginationFAV").innerHTML="",r.innerHTML=l(t,!0),b(),m()}function D(e){return e.map(t=>`<button class="category-btn js-category-btn" data-button="${t}">${t}</button>`).join("")}function F(){s.length>12&&window.innerWidth>767?(f=s.slice(0,12),r.innerHTML=l(f,!0),L(s)):s.length>9&&window.innerWidth<=767?(f=s.slice(0,9),r.innerHTML=l(f,!0),L(s)):(document.getElementById("paginationFAV").innerHTML="",r.innerHTML=l(s,!0)),b(),m(),y.classList.contains("fav-phantom")&&(y.classList.remove("fav-phantom"),r.classList.remove("fav-style-reset"))}function L(e,t=E){const n=Math.ceil(e.length/12),a=t,i=Z(n,a),o=Number(i)+2;if(n===1)return document.getElementById("paginationFAV").innerHTML="";const u=Q(a),d=tt(i,o,n,t),c=X(a,n),w=`<div class="pagination-bar">
    ...
    >
      <span class="icon-wrap left-single"></span>
        ...
        >
          ...
        </button>`),i}let h=0,S=12,v;document.addEventListener("click",async e=>{const t=e.target.closest(".pag-btn-number");if(f=$(t),t){p=t;const n=t.getAttribute("page-number"),a=l(f,!0);r.innerHTML=a,b(),m(),L(s,n)}});function $(e){return e===1?s.slice(0,12):(e&&(v=e.getAttribute("page-number")),s.length>12&&window.innerWidth>767?(h=12*v-12,S=12*v,s.slice(h,S)):(h=9*v-9,S=9*v,s.slice(h,S)))}function et(){r.addEventListener("click",e=>{if(!e.target.classList.contains("js-add"))return;const t=e.target.dataset.id,n=s.findIndex(({_id:a})=>a===t);s.splice(n,1),localStorage.setItem(g.LS_RECIPES,JSON.stringify(s)),nt(p??1),b(),m(),I(),s.length||(A.classList.remove("is-none"),y.classList.add("fav-phantom"),r.classList.add("fav-style-reset"),M.classList.add("is-none"))})}function m(){document.querySelectorAll(".js-add").forEach(t=>t.classList.add("liked"))}function nt(e){s.length>12&&window.innerWidth>767?(p&&(E=p.getAttribute("page-number")),r.innerHTML=l($(e),!0),L(s)):s.length>9&&window.innerWidth<=767?(p&&(E=p.getAttribute("page-number")),r.innerHTML=l($(e),!0),L(s)):(document.getElementById("paginationFAV").innerHTML="",r.innerHTML=l(s,!0)),b(),m(),y.classList.contains("fav-phantom")&&(y.classList.remove("fav-phantom"),r.classList.remove("fav-style-reset"))}
