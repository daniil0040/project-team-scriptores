...
//     return;
//   }
//     selectors.allCategBtn.classList.remove("all-categ-btn-active")

//         const lastCateg = document.getElementsByClassName("last-clicked");
//     lastCateg.classList.remove("last-clicked");
    
// evt.target.classList.add("category-button-active")
//     evt.target.classList.add("last-clicked")
